          ...
          <div className="space-y-6">
            <section className="bg-surface-lowest rounded-xl p-4 md:p-6 border border-border/40 shadow-card">
              <div className="flex flex-wrap items-center justify-between gap-2 mb-5">
                ...
                <span className="text-[11px] text-muted-foreground bg-surface-high px-3 py-1.5 rounded-full">Conformidade {conformidadePct}%</span>
              </div>
