...
const Auth = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="relative w-full max-w-md rounded-2xl p-8 bg-background/10 backdrop-blur-xl border border-primary-foreground/25 shadow-elevated text-primary-foreground">
